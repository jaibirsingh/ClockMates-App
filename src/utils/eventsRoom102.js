// Meetings scheduled for Room 102
...
export default [
    ...
    {
      'title': 'DTS STARTS - Room 102',
      'start': new Date(2021, 5, 13, 12, 0, 0, 0),
      'end': new Date(2021, 5, 13, 13, 0, 0, 0)
    },
    ...
    },
    {
      ...
      'start': new Date(2021, 6, 20, 19, 30, 0),
      'end': new Date(2021, 6, 22, 2, 0, 0)
    },
    {
      'title': 'Sample event',
      'start': new Date(2021, 6, 9, 19, 30, 0),
      'end': new Date(2021, 6, 9, 2, 0, 0)
    }
  ]
